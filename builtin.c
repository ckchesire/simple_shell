...
* @info: Structure containing param args
...
* @info: structure containing parameter args. Used to maintain
...
* @info: Structure containing parameter arguments to maintain
* constant function prototype.
* Return: Always '0'
*/
